<?php
    ...
    function todosProcessos ($filtro,$filtro1){
        ...
        $c = new conectar();
        $conexao = $c->conexao();
        $sql = "SELECT id_fornecedor, nrofa, consumidor, fornecedor, relator, ValorGrau_1,ValorGrau_2, data_jugamento, ano, recurso, camara  from processos where data_jugamento between '$filtro' and '$filtro1'";
