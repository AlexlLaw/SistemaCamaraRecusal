...
{ //class fornecedores{
    ...
    { // ver adicionarProcessos.php na linha 31
        ...
        $sql = "INSERT into fornecedores (id_usuario, nrofa, consumidor, fornecedor,  relator, valor,valor_2,data1,ano,recurso) VALUES ('$dados[0]', '$dados[1]',
		   '$dados[2]',
		   '$dados[3]',
			'$dados[4]',
			'$dados[5]',
...
//função que irá atualizar os dados da janela modal.
    ...
    { //esse $id tem que ser igual ao da linha 28.
        ...
        $sql = "SELECT id_fornecedor, nrofa, consumidor, fornecedor,  relator, valor,valor_2,data1,ano,recurso from fornecedores where id_fornecedor='$id' ";
...
//o comando UPDATE atualiza os dados.
        ...
        $sql = "UPDATE fornecedores SET nrofa = '$dados[1]', consumidor = '$dados[2]',fornecedor = '$dados[3]',relator = '$dados[4]',valor = '$dados[5]',valor_2='$dados[6]',data1= '$dados[7]', ano='$dados[8]' , recurso='$dados[9]'  where id_fornecedor = '$dados[0]'";
